...
class RRT:
    ...
    def __init__(self,
        ...
        self.play_area = self.AreaBounds(
            play_area) if play_area else None
...
def main(gx=5.0, gy=8.0):
    ...
    # === Cluster kiri atas ===
        ...
        # === Cluster tengah bawah ===
        (5, 5, 1),
        (7, 5, 1),
        (9, 5, 1),
        (9, 3, 1),

        # === Obstacle tunggal dekat goal ===
        (8, 10, 1),

        # === Obstacle besar kanan ===
        (14, 8, 3)
    ]
    ...
    rrt = RRT(
        ...
        expand_dis=2.0,          # lebih kecil → lebih presisi di celah sempit
        path_resolution=0.3,     # lebih halus
        goal_sample_rate=10,     # lebih sering ke goal
        max_iter=1000
)
